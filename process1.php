...
$q=mysqli_query($con,"insert into ticket1 values('','$flightID','$day','$month','$mob','$class','$source','$destination')");
 $p = mysqli_query($con,"INSERT into my values('','$BX_NAME','$BX_age','$BX_gender')");
...
var TODAY =d.getDate() +"- " + monthname[d.getMonth()] + "-" + d.getFullYear();
 ...
 document.write(TODAY);
            ...
            <fieldset class="row5">
                ...
                <p>
					<a class="submit" type="button" href="pay1.html" target="_self" value="Make Payment &raquo;" >Make Payment</a>
					<a class="submit" href="flight1.html" type="button"> Modify Search <a/>
